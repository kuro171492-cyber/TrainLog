...
- Заголовок (nav): две строки на мобильных
  - Строка 1: логотип (слева) + кнопки файла и GitHub (распределены слева и справа)
  - Строка 2: центральная кнопка "Новая сессия" (увеличена в 2 раза относительно версии v14)
